...
{
    ui->setupUi(this);
    ui->groupBox_e1->setVisible(false);
    ui->groupBox_e2->setVisible(false);
    ui->groupBox_e3->setVisible(false);
    ui->groupBox_e4->setVisible(false);
    ui->groupBox_e5->setVisible(false);
}
...
void MainWindow::on_checkBox_e1_clicked(bool checked)
{
    if (checked == true) {
        ...
        ui->groupBox_e1->setVisible(true);
    } else {
...
void MainWindow::on_checkBox_e2_clicked(bool checked)
{
    if (checked == true) {
        ...
        ui->groupBox_e2->setVisible(true);
    } else {
...
void MainWindow::on_checkBox_e3_clicked(bool checked)
{
    if (checked == true) {
        ...
        ui->groupBox_e3->setVisible(true);
    } else {
...
void MainWindow::on_checkBox_e4_clicked(bool checked)
{
    if (checked == true) {
        ...
        ui->groupBox_e4->setVisible(true);
    } else {
...
void MainWindow::on_checkBox_e5_clicked(bool checked)
{
    if (checked == true) {
        ...
        ui->groupBox_e5->setVisible(true);
    } else {
...
void MainWindow::on_actionSub_menu_2_triggered()
{
    QString filename = QFileDialog::getOpenFileName(
                    this,
        tr("Seleccionar patron"),
        "/home/juancho/Pictures",
        "Imagen (*.bmp | *.png | *.jpg | *.jpeg"
        );
    ui->listWidget_resultados->addItem(filename);
}
...
{
    ui->groupBox_e1->setEnabled(true);
    ui->checkBox_e1->setChecked(true);
    ui->groupBox_e1->setVisible(true);
}
...
{
    ui->groupBox_e2->setEnabled(true);
    ui->checkBox_e2->setChecked(true);
    ui->groupBox_e2->setVisible(true);
}
...
{
    ui->groupBox_e3->setEnabled(true);
    ui->checkBox_e3->setChecked(true);
    ui->groupBox_e3->setVisible(true);
}
...
{
    ui->groupBox_e4->setEnabled(true);
    ui->checkBox_e4->setChecked(true);
    ui->groupBox_e4->setVisible(true);
}
...
{
    ui->groupBox_e5->setEnabled(true);
    ui->checkBox_e5->setChecked(true);
    ui->groupBox_e5->setVisible(true);
}
