...
public:
    ...
    QAction *actionSub_menu_2;
    QAction *actionEjercicio_1;
    QAction *actionEjercicio_2;
    QAction *actionejercicio_3;
    QAction *actionEjercicio_4;
    QAction *actionEjercicio_5;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionSub_menu_2 = new QAction(MainWindow);
        actionSub_menu_2->setObjectName("actionSub_menu_2");
        actionEjercicio_1 = new QAction(MainWindow);
        actionEjercicio_1->setObjectName("actionEjercicio_1");
        actionEjercicio_2 = new QAction(MainWindow);
        actionEjercicio_2->setObjectName("actionEjercicio_2");
        actionejercicio_3 = new QAction(MainWindow);
        actionejercicio_3->setObjectName("actionejercicio_3");
        actionEjercicio_4 = new QAction(MainWindow);
        actionEjercicio_4->setObjectName("actionEjercicio_4");
        actionEjercicio_5 = new QAction(MainWindow);
        actionEjercicio_5->setObjectName("actionEjercicio_5");
        ...
        menuSub_menu = new QMenu(menuArchivo);
        menuSub_menu->setObjectName("menuSub_menu");
        menuEjercicios = new QMenu(menubar);
        menuEjercicios->setObjectName("menuEjercicios");
        ...
        menubar->addAction(menuEjercicios->menuAction());
        menuArchivo->addAction(menuSub_menu->menuAction());
        menuArchivo->addSeparator();
        menuArchivo->addAction(actionSalir_2);
        menuSub_menu->addSeparator();
        menuSub_menu->addAction(actionSub_menu_2);
        menuEjercicios->addAction(actionEjercicio_1);
        menuEjercicios->addSeparator();
        menuEjercicios->addAction(actionEjercicio_2);
        menuEjercicios->addSeparator();
        menuEjercicios->addAction(actionejercicio_3);
        menuEjercicios->addSeparator();
        menuEjercicios->addAction(actionEjercicio_4);
        menuEjercicios->addSeparator();
        menuEjercicios->addAction(actionEjercicio_5);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionSub_menu_2->setText(QCoreApplication::translate("MainWindow", "Sub-menu", nullptr));
        actionEjercicio_1->setText(QCoreApplication::translate("MainWindow", "Ejercicio 1", nullptr));
        actionEjercicio_2->setText(QCoreApplication::translate("MainWindow", "Ejercicio 2", nullptr));
        actionejercicio_3->setText(QCoreApplication::translate("MainWindow", "Ejercicio 3", nullptr));
        actionEjercicio_4->setText(QCoreApplication::translate("MainWindow", "Ejercicio 4", nullptr));
        actionEjercicio_5->setText(QCoreApplication::translate("MainWindow", "Ejercicio 5", nullptr));
        ...
        menuSub_menu->setTitle(QCoreApplication::translate("MainWindow", "Abrir ventana", nullptr));
        menuEjercicios->setTitle(QCoreApplication::translate("MainWindow", "Ejercicios", nullptr));
    } // retranslateUi
